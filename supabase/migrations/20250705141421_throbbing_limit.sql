/*
  ...
  1. New Table
    - `travel_buddy_notifications` - Stores notifications for travel buddy matches and messages
  
  2. Features
    - Notification types (match, message, buddy_request)
    - Read/unread status tracking
    - Automatic notification creation on match
