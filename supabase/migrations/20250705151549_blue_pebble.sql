/*
  ...
  3. Functions & Triggers
    - Auto-create notifications when users match
...
-- Drop existing function after trigger is removed
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'travel_matches') THEN
