/*
  ...
  3. Functions
    - Create match notification trigger function
...
CREATE FUNCTION create_match_notifications()
RETURNS TRIGGER AS $$
BEGIN
...
-- Drop existing functions with explicit parameter types to avoid conflicts
DO $$
BEGIN
