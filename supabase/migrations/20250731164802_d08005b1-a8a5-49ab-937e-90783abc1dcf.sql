-- Insert Vatican City detailed data
DO $$
DECLARE
...
BEGIN
    ...
    -- Insert photos
    INSERT INTO destination_photos (destination_id, url, caption, alt_text, category) VALUES
    (vatican_id, 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=800&h=600&fit=crop', 'St. Peters Basilica at sunrise', 'Majestic view of St Peters Basilica with its iconic dome', 'architecture'),
    (vatican_id, 'https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?w=800&h=600&fit=crop', 'Sistine Chapel interior', 'Interior view of the famous Sistine Chapel', 'interior'),
    (vatican_id, 'https://images.unsplash.com/photo-1518638150340-f706e86654de?w=800&h=600&fit=crop', 'Vatican Gardens view', 'Peaceful gardens within Vatican City walls', 'gardens');
END $$;