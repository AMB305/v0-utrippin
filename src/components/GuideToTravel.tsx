    ...
    <section className="guide-to-travel-section py-12 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 gap-0 items-stretch min-h-[400px]">
          {/* Text Content */}
          <div className="check-content-side-area flex flex-col justify-center px-8 lg:px-12 py-8">
          ...
          {/* Image */}
          <div className="relative set-img-area">
            <img
              src={guideImage}
              alt="Mountain landscape"
              className="w-full h-full object-cover set-img-area"
            />
          </div>
        </div>
      </div>
