    ...
    <div className="hidden lg:block bg-black min-h-screen text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="pt-20 px-6 py-10">
          ...
          <main className="max-w-4xl mx-auto mb-12">
            <div className="text-center">
              ...
              <BlurFade delay={1.1} inView>
                <div className="bg-zinc-800/80 backdrop-blur-sm p-6 rounded-xl shadow-lg max-w-2xl mx-auto text-white mb-8 border border-purple-500/20 hover:border-purple-500/40 transition-colors duration-300 cursor-pointer"
                     onClick={() => handleQuestionClick("Plan a 6-day adventure trip to Barcelona for 3 friends in October. Include hiking in Montserrat, a bike tour of the city, and a day for exploring Gothic Quarter. Budget-friendly options preferred.")}>
          ...
          {/* Chat Interface - Always Visible Below Welcome */}
              ...
              <BlurFade delay={2.2} inView>
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  <TextAnimate 
                    ...
                    once 
                    as="h2" 
                    className="text-xl font-bold text-gradient-keila"
                  >
                    Chat with Keila
                  </TextAnimate>
                </div>
                <p className="text-gray-400 text-sm">Ask me anything about your travel plans or click a suggestion above!</p>
              </BlurFade>
            </div>
