    ...
    <div className="hero-section-set relative h-screen overflow-hidden hidden lg:block">
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="text-center text-white px-4 max-w-4xl mx-auto">
          <h1 className="your-world-heading-style text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 bg-clip-text text-transparent mb-8 sm:mb-12 leading-tight tracking-wide text-center">
            YOUR WORLD<br />
            WITHIN REACH
          </h1>
