...
import { ChevronLeft, ChevronRight, Building2, Church, Globe, Trees, Waves, Mountain, ShoppingBag, Utensils, Music, Sparkles, Castle, Trophy, Heart, MoonStar, Tent, Wine, Gem, Compass, Leaf } from 'lucide-react';
