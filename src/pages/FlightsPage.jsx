...
export default function FlightsPage() {
  return (
    <div className="font-sans bg-[#f5f7fa] min-h-screen">
      {/* NAVBAR */}
      <div className="bg-[#0068EF] text-white py-4 px-6 flex justify-between items-center shadow">
      ...
      {/* HERO + SEARCH */}
      <div className="bg-[#004499] text-white py-20 relative">
        <div className="max-w-4xl mx-auto px-4">
          ...
          {/* FORM */}
          <div className="bg-white rounded-2xl p-6 shadow space-y-4 text-black">
            <div className="grid md:grid-cols-2 gap-4">
              <input type="text" placeholder="Departing from?" className="border p-4 rounded-full focus:ring-2 focus:ring-[#004499]" />
              <input type="text" placeholder="Going to?" className="border p-4 rounded-full focus:ring-2 focus:ring-[#004499]" />
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <input type="text" placeholder="Departing - Returning" className="border p-4 rounded-full focus:ring-2 focus:ring-[#004499]" />
              <div className="flex gap-4">
                <select className="border p-4 rounded-full w-full focus:ring-2 focus:ring-[#004499]">
            ...
            {/* BUNDLE */}
            <div className="bg-[#D0F1AC] text-[#006600] px-6 py-4 rounded-xl font-semibold flex flex-wrap gap-4 items-center">
              💰 Bundle + Save
