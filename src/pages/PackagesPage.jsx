...
export default function PackagesPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <ul className="hidden lg:flex items-center gap-2 text-sm">
                ...
                <li><a href="/packages" className="px-3 py-3 rounded-full text-[#0068EF] font-medium bg-blue-50">Packages</a></li>
      ...
      <div className="relative bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 min-h-[500px] flex items-center">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 flex gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 flex-1 max-w-2xl">
            <h1 className="text-3xl font-bold text-[#003C8A] mb-6">Find your next travel package</h1>
            ...
            <div className="space-y-4">
              ...
              {/* Package Type */}
              <div className="bg-[#D0F1AC] rounded-xl p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-green-700 font-bold text-sm">Package Includes</span>
                </div>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4 text-[#0068EF] border-2 border-gray-400 rounded focus:ring-[#0068EF]" defaultChecked />
                    <span>Flight</span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4 text-[#0068EF] border-2 border-gray-400 rounded focus:ring-[#0068EF]" defaultChecked />
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="relative h-48 bg-gradient-to-r from-purple-500 to-pink-600">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl font-bold">Save up to $500!</h3>
                  <p className="text-sm">Bundle flight + hotel for best deals!</p>
                  <button className="mt-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                    View Packages
                  </button>
                </div>
              </div>
      ...
      {/* Section 2: Recent Package Searches */}
        ...
        <div className="bg-blue-50 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg">Hawaii Vacation Package</h3>
                <p className="text-sm text-gray-600">Flight + Hotel + Car</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8">
              <div className="text-center">
                ...
                <div className="font-bold">Mon, Sep 15, 2025</div>
              </div>
              <div className="text-center">
                <div className="text-xs text-gray-500 uppercase">Return</div>
                <div className="font-bold">Fri, Sep 19, 2025</div>
              </div>
              <div className="text-center">
                <div className="text-xs text-gray-500 uppercase">Travelers</div>
      ...
      {/* Section 3: Package Deals */}
      <div className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold text-[#003C8A] mb-8">Popular Vacation Packages</h2>
          ...
          <div className="min-w-[300px] border-2 border-gray-200 rounded-2xl overflow-hidden">
            ...
            <div className="p-4">
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h3 className="font-bold">Hawaii</h3>
                  <div className="text-sm text-gray-600">5 days, 4 nights</div>
                </div>
              ...
              <div className="text-right">
                <div className="text-xs line-through text-gray-500">$2,299</div>
                <div className="text-2xl font-bold text-green-600">$1,849</div>
          ...
          <div className="min-w-[300px] border-2 border-gray-200 rounded-2xl overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="text-right">
                ...
                <div className="text-2xl font-bold text-green-600">$1,519</div>
                <div className="text-xs text-gray-600">per person</div>
              </div>
              <button className="w-full bg-gray-100 text-[#0068EF] font-bold py-2 rounded-full text-sm hover:bg-gray-200 mt-3">
                View Package
            ...
            <div className="p-4">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <div className="text-sm text-gray-600">6 days, 5 nights</div>
                </div>
                <div className="bg-green-100 text-green-800 text-xs font-bold px-2 py-1 rounded-full">
                  SAVE $320
                </div>
              ...
              <div className="text-right">
                <div className="text-xs line-through text-gray-500">$1,599</div>
                <div className="text-2xl font-bold text-green-600">$1,279</div>
                <div className="text-xs text-gray-600">per person</div>
              </div>
              <button className="w-full bg-gray-100 text-[#0068EF] font-bold py-2 rounded-full text-sm hover:bg-gray-200 mt-3">
                View Package
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#003C8A] mb-4">Sign up for Exclusive Package Deals</h2>
            <p className="text-gray-600 mb-8">Get access to bundle savings and vacation package offers.</p>
          ...
          <div className="bg-white rounded-2xl p-8 flex items-center gap-8">
            <div className="flex-1">
              ...
              <h3 className="text-3xl font-bold text-[#003C8A] mb-4">Vacation Package Deals. Only in the App.</h3>
              <p className="text-gray-600 mb-6">
                Discover exclusive vacation packages and bundle deals in our mobile app. Plan your perfect getaway!
              </p>
